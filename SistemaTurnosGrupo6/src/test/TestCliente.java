...
//        	System.out.println("Cliente DNI: " + clienteABM.traerPorDni(c1));
          ...
          System.out.println("********************* TRAER TODOS LOS CLIENTES********************************************");
            ...
            */      	
			...
			/*
			 * System.out.
			 * println("********************* CONSULTAR CLIENTE POR DNI ********************************************"
			 * ); int buscarDNI = 37349646; try { Cliente encontrado =
			 * clienteABM.consultarPorDni(buscarDNI); System.out.println("Buscar DNI: " +
			 * encontrado); } catch (Exception ex) { System.out.println("Error: " +
			 * ex.getMessage()); }
			 * 
			 * //LISTAR CLIENTES ACTIVOS es decir ACTIVO = TRUE System.out.
			 * println("********************* LISTAR CLIENTES ACTIVOS ********************************************"
			 * ); List<Cliente> clientesActivos = clienteABM.listarClientesActivos(); for
			 * (Cliente c : clientesActivos) { System.out.println(c); }
			 * 
			 * //LISTAR CLIENTES DADOS DE BAJA es decir ACTIVO = FALSE System.out.
			 * println("********************* LISTAR CLIENTES DADOS DE BAJA ********************************************"
			 * ); List<Cliente> clientesBaja = clienteABM.listarClientesDadosDeBaja(); for
			 * (Cliente c : clientesBaja) { System.out.println(c); }
			 * 
			 * //LISTAR CLIENTES DADOS DE ALTA EN UN INTERVALO DE FECHAS System.out.
			 * println("********************* LISTAR CLIENTES DADOS DE ALTA ENTRE FECHAS ********************************************"
			 * ); //LocalDate desde = LocalDate.now().minusDays(1); LocalDate desde =
			 * LocalDate.now().minusDays(7); LocalDate hasta = LocalDate.now().plusDays(1);
			 * List<Cliente> clientes = clienteABM.listarPorFechaAltaEntre(desde, hasta); if
			 * (clientes.isEmpty()) {
