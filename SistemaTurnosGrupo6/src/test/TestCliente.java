...
//        	System.out.println("Cliente DNI: " + clienteABM.traerPorDni(c1));
          ...
          System.out.println("********************* TRAER TODOS LOS CLIENTES********************************************");
            ...
            //CONSULTAR CLIENTE POR DNI
			 ...
			 try { Cliente encontrado = clienteABM.consultarPorDni(buscarDNI); 
			 ...
			 for(Cliente c : clientesActivos) { System.out.println(c); }
			 ...
			 for(Cliente c : clientesBaja) { System.out.println(c); }
